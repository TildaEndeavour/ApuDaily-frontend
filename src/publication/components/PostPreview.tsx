    ...
    return (
        <div className="h-screen w-300 py-4">
            <div className="mt-10">
                ...
                {(postPreview.tags && postPreview.tags?.length > 0) && <section className="px-4 py-4 my-5 flex flex-row gap-4 animate-fade-down animate-once animate-duration-1000 animate-ease-in-out animate-alternate animate-fill-both
                 bg-gray-100 rounded-3xl shadow-2xl">
